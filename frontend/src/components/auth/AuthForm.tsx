  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4">
      ...
      <div
        ...
        style={{ backgroundImage: 'url(/cherry-blossom.png)' }}
      />
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h2 className="text-2xl font-bold drop-shadow-sm">SOUL의 자전거 기록!!</h2>
          <p className="mt-1 text-sm text-muted-foreground">가족 자전거 운동을 기록하세요</p>
        </div>

        <div className="rounded-xl border border-border bg-card/90 backdrop-blur-sm p-6 shadow-lg">
